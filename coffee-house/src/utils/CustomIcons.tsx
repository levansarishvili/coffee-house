export function CoffeeIcon({ size = 20, className = "", ...props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShoppingBagIcon({ size = 20, className = "", ...props }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M11.6663 4.16667C11.6663 3.24619 10.9201 2.5 9.99967 2.5C9.0792 2.5 8.33301 3.24619 8.33301 4.16667"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function GooglePlayIcon({ size = 20, className = "", ...props }) {
  return (
    <svg
      width={size}
      height={size}
