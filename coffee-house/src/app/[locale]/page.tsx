  ...
  return (
    <>
      ...
      <section
        ...
        id="about"
      >
        <h2 className="about-header dark-txt heading-2-font heading-2-font-mob weight-600">
          Resource is
          <span className="accent">the perfect and cozy place</span> where you
          can enjoy a variety of hot beverages, relax, catch up with friends, or
          get some work done.
        </h2>
        <div className="about-images w-full">
          <div className="col-1 flex-col gap-40 w-full align-center">
            <div className="img-box-home overflow-hidden w-full">
              <img
                className="img-item w-full img-1"
            ...
            <div className="img-box-home overflow-hidden w-full">
              <img
                className="img-item w-full img-3"
                src="assets/about-2.jpg"
                alt="about image"
              />
            </div>
          </div>
          <div className="col-2 flex-col gap-40 w-full align-center">
            <div className="img-box-home overflow-hidden w-full">
              <img
                className="img-item w-full img-2"
            ...
            <div className="img-box-home overflow-hidden w-full">
              <img
                className="img-item w-full img-4"
